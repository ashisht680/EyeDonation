...
public class Constants {
    ...
    public static final String SELLER_LOGIN_URL = Constants.NEW_BASE_SELLER_URL + "sellerownerlogin.php";
    public static final String SELLER_PROFILE_URL = Constants.NEW_BASE_SELLER_URL + "shopView.php";
