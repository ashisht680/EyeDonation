...
import com.javinindia.ansheyedonate.apiparsing.stateparsing.CityMasterParsing;
                ...
                if (flag) {
                    for (int a = 0; a < list.size(); a++) {
                        ...
                        if (activity.getPackageManager().getApplicationLabel(res2.activityInfo.applicationInfo).equals("Photos")) {
                            ...
                            inten.setComponent(new ComponentName(res2.activityInfo.packageName, res2.activityInfo.name));
                            startActivityForResult(inten, CROP_FROM_CAMERA);
                            break;
                        }
