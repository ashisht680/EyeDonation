...
import com.javinindia.ansheyedonate.apiparsing.stateparsing.CountryMasterApiParsing;
...
import com.javinindia.ansheyedonate.picasso.CircleTransform;
...
public class NavigationAboutFragment extends BaseFragment implements View.OnClickListener, CheckConnectionFragment.OnCallBackInternetListener, EditProfileFragment.OnCallBackEditProfileListener {
    ...
    private void displayView(CharSequence title) {
        if (CheckConnection.haveNetworkConnection(activity)) {
            if (title.equals("Edit profile")) {
            ...
            } else if (title.equals("Membership")) {
                drawerLayout.closeDrawers();
                MembershipFragment fragment = new MembershipFragment();
                callFragmentMethod(fragment, this.getClass().getSimpleName(), R.id.container);
            } else if (title.equals("Eye care & FAQs")) {
                drawerLayout.closeDrawers();
                EyeCareFaqTabFragment eyeCareFragment = new EyeCareFaqTabFragment();
                ...
                callFragmentMethod(albumFragment, this.getClass().getSimpleName(), R.id.container);
    ...
    private void initialize(View view) {
        ...
        RelativeLayout rlFAQs = (RelativeLayout) view.findViewById(R.id.rlAboutUs);
        ...
        if (CheckConnection.haveNetworkConnection(activity)) {
            switch (v.getId()) {
                ...
                case R.id.rlEyeHospitals:
                    ...
                    break;
                case R.id.rlAboutUs:
                    AboutUSFragment aboutAppFragments = new AboutUSFragment();
                    callFragmentMethod(aboutAppFragments, this.getClass().getSimpleName(), R.id.container);
                    break;
                case R.id.rlEvents:
                ...
                case R.id.rlGallery:
                    ...
                    break;
                case R.id.rlEyeCare:
                    EyeCareFaqTabFragment eyeCareFaqTabFragment = new EyeCareFaqTabFragment();
                    callFragmentMethod(eyeCareFaqTabFragment, this.getClass().getSimpleName(), R.id.container);
                    break;
            }
        } else {
            methodCallCheckInternet();
